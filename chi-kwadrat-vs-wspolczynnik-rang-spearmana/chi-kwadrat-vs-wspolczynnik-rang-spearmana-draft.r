...
v_dane_ankieta_podsumowanie_phi = phi(dane_ankieta_podsumowanie, digits=8)
v_dane_ankieta_podsumowanie_rho = cor.test(dane_ankieta_wyniki[,1], dane_ankieta_wyniki[,2], method="spearman", exact=FALSE)$estimate
v_dane_ankieta_podsumowanie_phi = round(v_dane_ankieta_podsumowanie_phi, 8)
v_dane_ankieta_podsumowanie_rho = round(v_dane_ankieta_podsumowanie_rho, 8)
v_dane_ankieta_podsumowanie_phi == v_dane_ankieta_podsumowanie_rho
